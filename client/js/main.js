$(document).ready(function () {
  ...
  $(
    '#logo, #menuAnchorHome, #menuAnchorBiography, #menuAnchorDiscography, #menuAnchorJournal, #menuAnchorContactUs'
  ).click(function () {
  ...
  $('#menuAnchorHome').on('mouseenter', function () {
    ...
    if ($('#blobBg').attr('xlink:href') != 'images/menu-home-bg.jpg') {
      $('#blobBg').animateCss('fadeOut', function () {
        $('#blobBg')
          .attr('xlink:href', 'images/menu-home-bg.jpg')
          .animateCss('fadeIn');
        $('#header').removeClass('menuBarBgColored');
  ...
  $('#menuAnchorBiography').on('mouseenter', function () {
    if ($('#blobBg').attr('xlink:href') != 'images/menu-biography-bg.jpg') {
      $('#blobBg').animateCss('fadeOut', function () {
        $('#blobBg')
          .attr('xlink:href', 'images/menu-biography-bg.jpg')
          .animateCss('fadeIn');
        $('#header').removeClass('menuBarBgColored');
  ...
  $('#menuAnchorDiscography').on('mouseenter', function () {
    if ($('#blobBg').attr('xlink:href') != 'images/menu-discography-bg.jpg') {
      $('#blobBg').animateCss('fadeOut', function () {
        $('#blobBg')
          .attr('xlink:href', 'images/menu-discography-bg.jpg')
          .animateCss('fadeIn');
        $('#header').removeClass('menuBarBgColored');
  ...
  $('#menuAnchorJournal').on('mouseenter', function () {
    if ($('#blobBg').attr('xlink:href') != 'images/menu-journal-bg.jpg') {
      $('#blobBg').animateCss('fadeOut', function () {
        $('#blobBg')
          .attr('xlink:href', 'images/menu-journal-bg.jpg')
          .animateCss('fadeIn');
        $('#header').removeClass('menuBarBgColored');
  ...
  $('#menuAnchorContactUs').on('mouseenter', function () {
    if ($('#blobBg').attr('xlink:href') != 'images/menu-contact-us-bg.jpg') {
      $('#blobBg').animateCss('fadeOut', function () {
        $('#blobBg')
          .attr('xlink:href', 'images/menu-contact-us-bg.jpg')
          .animateCss('fadeIn');
        $('#header').removeClass('menuBarBgColored');
  ...
  $('.pageAnchors').each(function () {
    $(this).mouseleave(function () {
      if (
        $('#menuAnchorHome').hasClass('active') &&
        ...
        $('#menuAnchorBiography').hasClass('active') &&
        !$(this).hasClass('active')
      ) {
        $('#blobBg')
          .attr('xlink:href', 'images/menu-biography-bg.jpg')
        ...
        $('#menuAnchorDiscography').hasClass('active') &&
        !$(this).hasClass('active')
      ) {
        $('#blobBg')
          .attr('xlink:href', 'images/menu-discography-bg.jpg')
        ...
        $('#menuAnchorJournal').hasClass('active') &&
        !$(this).hasClass('active')
      ) {
        $('#blobBg')
          .attr('xlink:href', 'images/menu-journal-bg.jpg')
        ...
        $('#menuAnchorContactUs').hasClass('active') &&
        !$(this).hasClass('active')
      ) {
        $('#blobBg')
          .attr('xlink:href', 'images/menu-contact-us-bg.jpg')
  ...
  $(window).on('hashchange load', function () {
    ...
    switch (hash) {
      case '':
        ...
        $('#header')
          .toggleClass('menuBarBgColored')
          .css('background', '#0B0305');
        break;
      case 'page1':
        $('#menuAnchorHome')
          .addClass('active')
